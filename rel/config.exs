...
environment :pescadero do
  set(include_erts: true)
  set(include_src: false)
  set(cookie: :"q0l{pOQ4prFE!%lPs^H/Qb^h2zGmxyh9Re:5r2^<GcTz5q?i0=MN_*:e~FI)2xeY")
  set(vm_args: "rel/vm.args")
  ...
  set(
    config_providers: [
      {Distillery.Releases.Config.Providers.Elixir, ["${RELEASE_ROOT_DIR}/etc/pescadero.exs"]}
    ]
  )

  set(
    overlays: [
      {:copy, "rel/config/pescadero.exs", "etc/pescadero.exs"}
    ]
  )
end
