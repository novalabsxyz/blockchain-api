defmodule BlockchainAPI.Schema.Reward do
  ...
  @fields [:id, :block_height, :type, :account_address, :amount]
  ...
  def changeset(transaction, attrs) do
    transaction
    |> cast(attrs, [:block_height, :type, :amount, :account_address])
    |> validate_required([:block_height, :type, :account_address, :amount])
